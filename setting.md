...
- Boann (Mannannán I) — tidally-heated subsurface ocean moon. Named for the goddess of the River Boyne and a hidden, forbidden well. Orbital distance locked at 350,000 km from Mannannán, e = 0.008 (i = 1.26°) — a small forced eccentricity, in the same range as real tidally-heated moons (Europa e ≈ 0.009, Enceladus e ≈ 0.005), chosen specifically to sustain the tidal flexing the settlement's whole premise depends on.
- Mannannán II, III — minor uninhabited moons, now with locked physical data: II is 370.5 km radius / ~1.246×10²¹ kg at 420,000 km (e = 0.02, i = 0.48°); III is 380.0 km radius / ~1.002×10²¹ kg at 460,000 km (e = 0.01, i = 0.13°).
...
Boann (Mannannán I) is a tidally-heated subsurface ocean moon — a differentiated body with an icy shell, a thick liquid-water layer beneath that shell, and a modest silicate core. Surface gravity is 0.02g (0.196 m/s²), implying a mass of roughly 8.9 × 10²⁰ kg (~0.00015 M⊕) at a radius of 550 km, and a bulk density of ~1,275 kg/m³ — physically consistent with a real ice/rock body of this size (Saturn's actual moon Rhea, comparable radius, has a density of 1,236 kg/m³). Orbital distance from Mannannán is locked at 350,000 km, with eccentricity 0.008 — small but nonzero, in the same range as Europa (e ≈ 0.009) and Enceladus (e ≈ 0.005), the real moons this whole settlement concept is modeled on. That eccentricity is what actually sustains the tidal flexing (a perfectly circular orbit wouldn't), and it's the physical basis for everything else in this section: the ice-shell stress, the icequakes, the deliberately-sited tidal-heating hotspot the borehole exploits. The settlement is built around a single deep borehole, sunk through roughly 3–5 km of ice at that hotspot, opening into the subsurface ocean proper. A submerged station sits at the ocean floor above hydrothermal-vent fields; habitat cavities are carved into the ice at intervals along the shaft.

*Note: a locked eccentricity this small will decay over geological time without something to sustain it — real Europa/Enceladus-style tidal heating is usually maintained by an orbital (Laplace-style) resonance with a sibling moon, not eccentricity alone in isolation. Whether Boann is in resonance with Mannannán II, III, or Safford Danu's host moon is still an open question (not yet decided), but doesn't block anything currently written — the eccentricity is locked and load-bearing regardless of which mechanism sustains it long-term.*
...
- ~~Boann's locked orbit didn't by itself explain ongoing tidal heating.~~ **Resolved** — Boann's orbit now has a locked eccentricity of 0.008 (Europa/Enceladus range), which sustains the tidal flexing directly (§7.1). Still open, lower priority: whether a resonance with Mannannán II, III, or Safford Danu's host moon is what maintains that eccentricity long-term, or whether it's simply locked as a standing setting fact.
