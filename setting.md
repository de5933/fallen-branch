...
**Settlement architecture:** rather than one dense city, Lugh's population (no hard figure established; described qualitatively as the system's primary agricultural hub) is spread as a **linear settlement following the terminator line** — agricultural domes and hab modules strung across the twilight band for potentially hundreds of kilometers, using **perpetual-sunset mirror arrays** (bible-established) to redirect and concentrate the day side's light into greenhouse domes on Earth-like day/night cycles. Hab modules are a surface/shallow-subsurface hybrid: living quarters can sit above ground with real windows, while deeper levels handle resource processing and storage, insulated by regolith the way Earth basements use soil.
