...
**Star(s):** Wide binary. Danu A: K2V, ~0.8 M☉ (primary; all planets orbit this star). Danu B: M4V red dwarf companion, ~0.25 M☉, separated by roughly 500–800 AU — negligible gravitational effect on the planets; visible as a fixed, reddish second point of light in the sky. Barycentric orbital elements now locked: Danu A at 148.78 AU from the barycenter (e = 0.019, i = 0.15°), Danu B at 507.28 AU (e = 0.009, i = 0.23°) — total separation ~656 AU, consistent with the ~500–800 AU figure above. Kepler's third law on this pair gives an orbital period of roughly 16,400 years, so on any story or gameplay timescale Danu B is effectively fixed in the sky — no orbital motion worth modeling.
...
- Boann (Mannannán I) — tidally-heated subsurface ocean moon. Named for the goddess of the River Boyne and a hidden, forbidden well. Orbital distance now locked at 350,000 km from Mannannán (e = 0.0, i = 1.26°) — see the Boann subsection below for a flag on what this implies for the tidal-heating mechanism.
...
Boann (Mannannán I) is a tidally-heated subsurface ocean moon — a differentiated body with an icy shell, a thick liquid-water layer beneath that shell, and a modest silicate core. Surface gravity is 0.02g (0.196 m/s²), implying a mass of roughly 8.9 × 10²⁰ kg (~0.00015 M⊕) at a radius of 550 km, and a bulk density of ~1,275 kg/m³ — physically consistent with a real ice/rock body of this size (Saturn's actual moon Rhea, comparable radius, has a density of 1,236 kg/m³). Orbital distance from Mannannán is now locked at 350,000 km. The settlement is built around a single deep borehole, sunk through roughly 3–5 km of ice at a deliberately chosen tidal-heating hotspot where the shell thins locally, opening into the subsurface ocean proper. A submerged station sits at the ocean floor above hydrothermal-vent fields; habitat cavities are carved into the ice at intervals along the shaft.

*Open flag: the locked orbit above has eccentricity 0.0. A perfectly circular orbit alone doesn't sustain ongoing tidal flexing — real tidally-heated moons (Europa, Enceladus) need either continuous nonzero eccentricity or an orbital (Laplace-style) resonance with a sibling moon to keep the ice shell working. Boann's current locked companions (Mannannán II/III, Safford Danu's host moon) aren't yet confirmed to be in resonance with it. This doesn't invalidate anything already written, but it's worth deciding — either give Boann's orbit a small locked eccentricity after all, or establish a specific resonance partner — before the tidal-heating mechanism gets any more load-bearing detail (e.g. the icequake hazard note below).*
...
- **New:** Boann's locked orbit (350,000 km, e = 0.0) doesn't by itself explain ongoing tidal heating — a circular orbit needs either a nonzero eccentricity or a resonance partner to keep flexing the ice shell. Decide which mechanism applies (a small locked eccentricity, or a resonance with Mannannán II/III/Safford Danu's host moon) before building further on the icequake/shaft-fatigue hazard detail in §7.1.
