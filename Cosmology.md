...
*Split from the master worldbuilding bible (`setting.md`) by topic. Section markers like §7.1 refer to the original numbering and may now point to content living in a different file — cross-check against the other topic files if a reference doesn't resolve locally.*
